...
const LANG_COLORS = { javascript:C.yellow, typescript:C.blue, python:C.green, rust:'#ff9f43', go:'#89ddff', react:'#61dafb', 'react-ts':'#61dafb', tailwind:'#38bdf8', nextjs:'#e2e2f0', nodejs:'#68a063', express:'#68a063', vue:'#42b883', svelte:'#ff3e00', html:'#e34c26', cpp:'#00599c', java:'#ed8b00', default:C.accent }
const LANG_ICONS  = { python:'🐍', typescript:'📘', rust:'🦀', go:'🐹', javascript:'📄', react:'⚛️', 'react-ts':'⚛️', tailwind:'💨', nextjs:'▲', nodejs:'🟢', express:'🚂', vue:'💚', svelte:'🧡', html:'🌐', cpp:'⚙️', java:'☕', default:'📁' }
